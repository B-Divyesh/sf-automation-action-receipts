...
- Reset: choose **Reset demo**. Browser demo state uses the `demo:` localStorage namespace and is discarded without changing non-demo storage. CLI output is isolated from the caller's directory.
